...
<div id="wapper" class="<?php if ( is_front_page()) { echo 'home-main color-white';} else {echo '';}?>">
	<header id="header" class="position-relative">	
		<div class="container">
			<div class="list-flex flex-middle flex-center">
				...
				<div class="logo"><a href="<?php echo home_url(); ?>"><img src="<?php echo get_field('logo','option') ?>" alt=""></a></div>
				<button href="<?php echo get_field('subscribe_link','option') ?>" class="ed-btn btn-popup"><?php echo get_field('subscribe_title','option') ?></button>
			</div>
		</div>
		<div class="menu-main">
			<div class="container">
		...
		<div class="hd-search-form">
			<div class="container">
				<form action="<?php echo get_home_url(); ?>/" method="get">
					<input type="text" id="s" name="s" class="form-control" value="" placeholder="Type what you are looking for">
			...
			<div class="popup-bg">
				<div class="popup-box list-flex">
					<div class="featured image-fit">
						<img class="on-pc" src="<?php echo get_template_directory_uri(); ?>/assets/images/popup.jpg" alt="">
						<img class="on-sp" src="<?php echo get_template_directory_uri(); ?>/assets/images/sp-popup.jpg" alt="">
					</div>
					<div class="info">
						<img class="close" src="<?php echo get_template_directory_uri(); ?>/assets/images/close.svg" alt="">
						<div class="box">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-popup.png" alt="">
