		...
		<div class="sg-lastest-list">
			...
			<div class="sg-lastest-it">
				...
				<div class="info">
					...
					<p class="has-large-font-size mr-bottom-20"><a class="pri-color-2" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></p>
					...
					?>
					<div class=""><p class="pri-color-2"><?php echo $yoast_meta; ?></p></div>
					<?php } ?>
				</div>
			</div>
			<?php
