...
function rm_call_shortcode($info)
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://wordpress-1312425-4788967.cloudwaysapps.com/wp-json/api/v1/repmax-calculate/',
...
function create_shortcode_tool_rm($args, $content)
{
	...
	wp_enqueue_script('bmr-js', get_template_directory_uri() . '/shortcode/calorie/assets/js/repmax-tool.js', '', '1.0.0');
