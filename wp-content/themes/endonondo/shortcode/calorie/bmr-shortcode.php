	...
	<div class="calories-box">
		...
		<div class="calories-form">
			...
			<form action="" id="bmrCalculate">
				<div class="form-row">
					<div class="form-col">
						<label for="">Gender <img src="<?=get_template_directory_uri() . '/shortcode/calorie/assets/images/calories-note.svg'?>" alt=""></label>
						<div class="form-radio-list">
							<div class="form-radio checked">
								<label for="genderMale"><input type="radio" name="info[gender]" value="1" id="genderMale" checked>
				...
				<div class="form-row">
					<div class="form-col">
						...
						<label for="">BMR estimation formula: <img src="<?=get_template_directory_uri() . '/shortcode/calorie/assets/images/calories-question.svg'?>" alt=""></label>
						<div class="form-radio-list form-radio-list-full">
						 ...
						    </div><div class="input-body" style="opacity: 0">
