...
function tdee_call_shortcode($info) {
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => 'https://dev.ehproject.org/wp-json/api/v1/tdee-calculate/',
        ...
        <div class="result">
            <div class="main-result">
                <?php if(isset($calorie->gain)):?>
                    <p>The estimated TDEE or body weight maintenance energy requirement is <span class="primary-title"><?= $calorie->maintain->calorie?></span> Calories per day.</p>
                    <p>BMI Score: <?= $bmi->bmi?> kg/m2 <span class="primary-title"><?= " ( ". $bmi->description . " ), " ?></span><?= $bmi->healthy_range?></p>
                <?php else:?> 
