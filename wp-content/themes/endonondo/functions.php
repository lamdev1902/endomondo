...
function theme_mcs_scripts() {
	...
	wp_enqueue_style( 'style-main', get_template_directory_uri() . '/assets/css/main.css','','1.3.2' );
	wp_enqueue_style( 'style-custom', get_template_directory_uri() . '/assets/css/custom.css','','1.2.1' );
	wp_enqueue_style( 'style-base', get_template_directory_uri() . '/assets/css/base.css','','1.1.9' );
	wp_enqueue_style( 'style-element', get_template_directory_uri() . '/assets/css/element.css','','1.3.0' );
	wp_enqueue_style( 'style-responsive', get_template_directory_uri() . '/assets/css/responsive.css','','1.2.7' );
