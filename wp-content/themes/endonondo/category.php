		...
		<div class="blog-main category-main">
				...
				<div class="category-link-box">
					<div class="category-link list-flex">
						...
						$term_id_item = $category->term_id;
						 ?>
							<a class="<?php if($term_id_item == $term_id) echo 'active'; ?>" href="<?php echo get_term_link($category->term_id); ?>"><?php echo $category->name; ?></a>
						<?php } ?>
					</div>
				</div>
			</div>
			<div class="category-top blog-top position-relative">
				<div class="top-box list-flex">
					<div class="info">
						<h1 class="ed-title text-uppercase color-white"><?php echo $terms_current->name; ?></h1>
					...
					<?php } ?>
					<p class="on-sp"><?php echo $terms_current->description; ?></p>
				</div>
			</div>
			<div class="container">
				<?php if($term_children){ ?>
					<div class="cat-list">
						...
						<div class="cat-it">
							<div class="blog-all">
								<h2 class="ed-title"><?php echo $term->name; ?></h2>
							...
							<div class="text-center">
								<a href="<?php echo $term_link; ?>" class="link-all ed-btn">See all post</a>
							</div>
						</div>
					<?php } } } ?>
					</div>
